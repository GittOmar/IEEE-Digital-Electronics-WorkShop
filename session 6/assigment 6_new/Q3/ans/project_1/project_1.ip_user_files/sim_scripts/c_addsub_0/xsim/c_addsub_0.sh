...
#
# Generated by Vivado on Sun Jun 15 14:33:09 +0300 2025
...
xv_boost_lib_path=D:/programmes/vivado/Vivado/2019.1/tps/boost_1_64_0
xvhdl_opts="--relax"
...
{
  file="xsim.ini"
  lib_map_path="D:/programmes/vivado/Vivado/2019.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
